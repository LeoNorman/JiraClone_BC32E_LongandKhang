...
const Header = () => {
    ...
    const renderLogin = () => {
        if (_.isEmpty(userLogin)) {
            return <Fragment>
                <button className="px-8 py-3 font-semibold rounded bg-green-600 text-gray-50 mr-5" onClick={() => {
                    history.push('/login')
                }}>Sign in</button>
                <button className="px-8 py-3 font-semibold rounded bg-green-600 text-gray-50" onClick={() => {
