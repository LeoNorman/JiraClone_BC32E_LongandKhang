                ...
                <div className="row">
                    <div className="col-4">
                        ...
                        <div className="form-group">
                            ...
                            <input onChange={formik.handleChange} value={formik.values.id} disabled className="form-control" name="id" />
                        </div>
                    ...
                    <div className="col-4">
                        <div className="form-group">
                            ...
                            <input value={formik.values.projectName} className="form-control" name="projectName" onChange={formik.handleChange} />
                        </div>
                    </div>
                    <div className="col-4">
                        <div className="form-group">
                            <p className="font-weight-bold">Project Category</p>
                            <select onChange={formik.handleChange} className="form-control" name="categoryId" value={formik.values.categoryId}>
