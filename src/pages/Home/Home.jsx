    ...
    <div className='mt-5'>
      ...
      <div className='container'>
        ...
        <ul className='text-center'>
          ...
          <li>1. Chọn <span className='text-green-500'>'Đăng Nhập'</span> nếu bạn đã có tài khoảng. Sau khi đăng nhập bạn sẽ được đưa sang dự án của chúng tôi!!</li>
          <li>2. Chọn <span className='text-green-500'>'Đăng Ký'</span> nếu bạn chưa có tài khoảng. Hoặc sau khi nhấn 'Đăng nhập' bạn chọn tiếp 'NOT ACCOUNT?' để đăng ký tài khoảng!!</li>
